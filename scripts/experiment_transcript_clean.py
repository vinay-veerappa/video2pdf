...
"""
    ...
    # Normalize timestamps: Fix malformed timestamps like [00:00:33:04] -> [00:33:04]
    import re
    def normalize_timestamp(match):
        ts = match.group(1)
        parts = ts.split(':')
        if len(parts) == 4:
            # [00:00:33:04] -> [00:33:04] (remove leading 00:00)
    ...
    final_text = re.sub(r'\[([0-9:]+)\]', normalize_timestamp, final_text)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Clean transcript using Ollama")
